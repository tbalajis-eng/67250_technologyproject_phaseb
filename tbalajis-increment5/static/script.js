...
/* ------------------------------------------------------------
   INCREMENT 5: Hamburger Nav Toggle (responsive)
   ------------------------------------------------------------ */
function toggleNav() {
...
/* ------------------------------------------------------------
   INCREMENT 5: Leaflet Map initialisation
   Only runs on pages that contain div#map.
   ------------------------------------------------------------ */
function initMap() {
...
// Call initMap on pages that have a map container
initMap();
